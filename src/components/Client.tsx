    ...
    <Container fluid className="bg-all min-vh-100 d-flex align-items-center justify-content-center">
            <Row className="">
                <div>
                    ...
                    <p className="text-center text-muted">to enjoy all of our cool <a href="#" className="text-primary">services</a> ✌️</p>
                </div>
                <div className="shadow p-3 bg-white rounded my-3 mx-auto my-3 w-75 w-lg-50">
                    ...
                    <div className="text-center mt-3">
                        <small>New here? <Link href="/contact-us" className="text-primary">Contact Us!</Link></small>
                    </div>
                </div>
            </Row>
    </Container>
