    ...
    <Container fluid className="bg-all min-vh-100 d-flex align-items-center justify-content-center">
            <Row className="">
                <div>
                    ...
                    <p className="text-center text-muted">to access your virtual dashboard <a href="#" className="text-primary">services</a> ✌️</p>
                </div>
                <div className="shadow p-3 bg-white rounded my-3 mx-auto my-3 w-75 w-lg-50">
                    ...
                    <div className="text-center mt-3">
                        <small>Intern here? <Link href="/intern-login" className="text-primary">Intern Login!</Link></small>
                    </div>
                </div>
            </Row>
    </Container>
